...
@interface CP_GCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation CP_GCDTimerManager

#pragma mark - Public Method

+ (CP_GCDTimerManager *)sharedInstance
{
    static CP_GCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[CP_GCDTimerManager alloc] init];
    });
                                ...
                                action:(dispatch_block_t)action
{
    ...
    switch (option) {
        ...
        case ActionOption_AbandonPrevious:
        {
            /* 移除之前的action */
        ...
        case ActionOption_MergePrevious:
        {
            /* cache本次的action */
